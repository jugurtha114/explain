...
def print_help_message():
    ...
    print(f"{BOLD}explain – Made by @shobrook{END}")
    print("Command-line tool that automatically explains your error message using ChatGPT.")
    print(f"\n\n{UNDERLINE}Usage:{END} $ explain {CYAN}[file_name]{END}")
    print(f"\n$ python3 {CYAN}test.py{END}   =>   $ explain {CYAN}test.py{END}")


def print_invalid_language_message():
    print(f"\n{RED}Sorry, explain doesn't support this file type.\n{END}")
